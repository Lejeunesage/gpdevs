        ...
        <div class="flex">
                ...
                <section>
                    ...
                    <ul v-else>
                        <li v-for="project in props.projets" :key="project.id"
                            class="shadow border-gray-200 rounded p-2 mb-4 bg-slate-100">
                            ...
                            <div class="text-sm  text-gray-600 pb-1"> {{ project.progress }}
                                <div class="w-full  bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="bg-slate-500 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full"
                            ...
                            <button @click="viewProject(project.id)"
                                class="bg-gradient-to-r from-blue-500 to-blue-700  text-white  px-2 py-1 mt-2 rounded">Voir le projet</button>
                        </li>
                    </ul>
                </section>
            ...
            <div class="w-1/2 p-4 border-l">
                <section>
                    ...
                    <ul v-else>
                        <li v-for="task in props.taches" :key="task.id" shadow class="shadow bg-slate-100 rounded p-2 mb-4">
                            ...
                            <button @click="viewTask(task.id)" class="bg-gradient-to-r from-blue-500 to-blue-700 text-white px-2 py-1 mt-2 rounded">Voir la
                                tâche</button>
                        </li>
                    </ul>
                </section>
