...
<template>
  ...
  <footer class="relative z-10 bg-slate-800 text-white pt-20 pb-10 lg:pt-[120px] lg:pb-20">
    <div class="container mx-auto px-5">
      <div class="-mx-4 flex flex-wrap">
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="mb-10 w-full">
            <div class="my-10">
              <h1 class="text-4xl font-bold">Safira <span class="text-red-800">.</span></h1>
            </div>
        ...
        <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
          <div class="mb-10 w-full">
            ...
            <p class="text-body-color text-base">&copy; 2023 Safira</p>
          </div>
        </div>
      </div>
    </div>
