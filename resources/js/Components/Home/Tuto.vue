            ...
            <div class="-mx-4 flex flex-wrap">
                <div class="w-full px-4 lg:w-1/2">
                    <div class="max-w-[490px] py-[100px] lg:py-[140px]">
                        <span class="mb-3 block text-base font-semibold ">
                            Suivez un tutoriel pour comprendre le fonctionnement
                        </span>
                        <h2 class="mb-6 text-3xl font-bold  sm:text-4xl md:text-[40px]">
                            Une solution innovantes pour booster vos projets.
                        </h2>
                        ...
                        <a href="javascript:void(0)"
                            class="inline-block rounded-full border border-white py-3 px-9 text-base font-medium  hover:bg-white hover:text-primary">
        ...
        <div>
            <div class="top-0 right-0 z-10 h-full w-full lg:absolute lg:w-1/2">
                <div class="flex h-full w-full items-center justify-center">
                    <img src="https://cdn.tailgrids.com/2.0/image/marketing/images/videos/image-02.jpg" alt="image"
            ...
            <span class="absolute left-0 top-0 z-[-1]">
                <svg width="659" height="562" viewBox="0 0 659 562" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="211" cy="114" r="448" fill="white" fill-opacity="0.04" />
                </svg>
            </span>
